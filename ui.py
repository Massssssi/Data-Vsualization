...
questions = [["What is the plastic pollution emmission produced by the most polluting country?", 1, "bar"],
            ...
            ["Adding up pollution over all years, what is the pollution produced by the most polluting country?", 7, "bar"],
            ["Adding up pollution over all years, what is the pollution produced by the most polluting country?", 7,"heat"],
